...
export const appRouter = createBrowserRouter([
  {
    ...
    children: [
      ...
      // ==========================================
      // SCOPE UTILIZATORI: Protejate cu allowedRole="user"
      // ==========================================
      {
      ...
      // ==========================================
      // SCOPE ADMIN: Protejate cu allowedRole="admin"
      // ==========================================
      {
      ...
      // ==========================================
      // SCOPE COMUN: Rute accesibile de ambele roluri (doar logat să fii)
      // ==========================================
      {
      ...
      // Rute tehnice/utilitare nesecurizate în mod direct
